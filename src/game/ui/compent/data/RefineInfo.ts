...
import { RefineVo } from "../../../../db/sheet/vo/RefineVo";

export class  RefineInfo {
    public Slot:number;//1~6
    public StrLv:number;//强化等级
    public StrExp:number;//当前强化经验
    private vo:RefineVo;
    private nextVo:RefineVo;
    constructor() {
    ...
    public initInfo(pos:number,lv:number,exp:number):void
    {
        ...
        this.StrLv = lv; 
        this.StrExp = exp;
        this.vo = RefineVo.getByLv(this.StrLv);
        this.nextVo = RefineVo.getByLv(this.StrLv + 1);
    }
