import { StrenthenVo } from "../../../../db/sheet/vo/StrenthenVo";
...
export class  StrengthInfo {
    ...
    private vo:StrenthenVo;
    private nextVo:StrenthenVo;
    constructor() {
    ...
    public initInfo(pos:number,lv:number,exp:number):void
    {
        ...
        this.StrLv = lv; 
        this.StrExp = exp;
        this.vo = StrenthenVo.getByLv(this.StrLv);
        this.nextVo = StrenthenVo.getByLv(this.StrLv + 1);
    }
