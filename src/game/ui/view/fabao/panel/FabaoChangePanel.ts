...
export class FabaoChangePanel extends ui.main.EquipChangePanelUI {
    ...
    public open(...args): void {
        this.initWindow(true, true, "法宝替换", 486, 490, 210);
        super.open();
        this.useVo = args[0];
        this.clickIndex = -1;


        var posEquip = SBagData.instance.fabao.allItems;
        this.equipDataList = [];
    ...
    private initList(): void {
        this.equipList.itemRender = FabaoChangeItem;
...
//竞技场对手的item
export class FabaoChangeItem extends Laya.View {
    ...
    public set dataSource(data: ItemData) {
        ...
        var panel = this.parent.parent.parent as FabaoChangePanel;
    ...
    public thisClick(): void {
        ...
        (this.parent.parent.parent as FabaoChangePanel).itemClick(this._mdata);
    }
