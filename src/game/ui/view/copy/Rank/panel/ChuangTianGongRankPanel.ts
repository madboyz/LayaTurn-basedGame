...
export class ChuangTianGongRankPanel extends ui.main.SanjieCopyRankPanelUI {
    constructor() {
        super();
    ...
    private initList(): void {
        this.list.itemRender = ChuangTianGongRankItem;
    ...
    public updateData(): void {
        ...
        if (SCopyData.instance.chuangTianGongRankInfo) {
            if (SCopyData.instance.chuangTianGongRankInfo.MyRank <= 0) {
                rankStr = "(未上榜)";
            } else {
                rankStr = "(第" + SCopyData.instance.chuangTianGongRankInfo.MyRank + "名)";
            }
            myRankStr = (SBossData.instance.chuangTiangongChapInfo.DunNo - 25001) + "层";
            this.list.array = SCopyData.instance.chuangTianGongRankInfo.item_1;
        } else {
            rankStr = "(未上榜)";
        }
    ...
    public open(...args): void {
        this.initWindow(true, true, "勇闯天宫排名", 486, 524, 165);
        (new RankMainProrocol().RequsetRank(RankType.CHUANGTIANGONG, 50, 1))
        super.open();
    }
    ...
    private oldItem: any;
    private selectItem: ChuangTianGongRankItem;
    private onListChangeHandler(): void {
        this.selectItem = this.list.getCell(this.list.selectedIndex) as ChuangTianGongRankItem;
    ...
    private rewardLbClick(): void {
        var rankNo = SCopyData.instance.chuangTianGongRankInfo.MyRank;
        var cfgs = Rank_reward_cfgVo.get(RankType.CHUANGTIANGONG).rewards
...
export class ChuangTianGongRankItem extends ui.main.TongtiantaRankItemUI {
