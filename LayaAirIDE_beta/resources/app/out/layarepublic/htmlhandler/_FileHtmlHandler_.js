...
var staticHelp = /^\s\bstatic\b\s+\w+:((?:\w+\.?)+)\s*=\s*new\s+$/ //.exec(str)[1]
...
var htmlHandlerScript = function()
{
    ...
    for (var i = 0; i < fileNodes.length; i++)
    {
        ...
        {
            var tempIndex = sriptList.indexOf(currentNode.url);
            if (-1 === tempIndex) {
        ...
        for (var j = i; j < fileNodes.length; j++)
        {
            ...
            for (var k = 0; k < currentNode.parentClassList.length; k++)
            {
                ...
                if (index >= 0)
                {
                    ...
                    {
                        sriptList.splice(currentNodeIndex, 0, checkNode.url);
                    }
                    ...
                    else if (currentNodeIndex != -1 && checkNodeIndex != -1)
                    {
                        ...
                        {
                            sriptList.splice(checkNodeIndex, 1);
                            sriptList.splice(currentNodeIndex, 0, checkNode.url);
                        }
                    }
                }
