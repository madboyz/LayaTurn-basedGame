...
declare namespace BlackCat {
    class Main {
        ...
        private doPlatNotify;
        static continueRefund(): Promise<void>;
        private doPlatNotiyRefund;
        private doPlatNotifyRefundRes;
        private confirmPlatNotify;
        private confirmPlatNotifyExt;
...
declare namespace BlackCat {
    class LangCN extends LangBase {
        lang: {
            ...
            register_inputUid_format_err: string;
            register_inputAccount: string;
            register_inputAccount_err: string;
            register_inputAccount_err_type: string;
            ...
            login_inputAccount: string;
            login_inputAccount_err: string;
            ...
            forgetpass_inputUid_format_err: string;
...
declare namespace BlackCat {
    class ApiTool {
        ...
        static addUserWalletLogs(uid: string, token: string, txid: string, g_id: string, cnts: string, type: string, params: string, net_type: number): Promise<any>;
...
declare namespace BlackCat {
    ...
    class NEOGAMESDK {
        ...
        static getRandom(callback: any): number;
        private static postMessagge;
        static init(): void;
        static getUserInfo(callback: Function): void;
        static getSgasBalance(callback: Function): void;
        static invokescript(data: invokescriptInfo, callback: Function): void;
        static makeRawTransaction(data: RawTransInfo, callback: Function): void;
        static makeRecharge(data: MintTokenTransInfo, callback: Function): void;
        static getRecharge(data: getMintTokenTransInfo, callback: Function): void;
    }
    class Result {
        err: boolean;
        info: any;
...
declare namespace BlackCat.tools {
    class wallet {
        ...
        makeRawTransaction(params: any): Promise<Result>;
