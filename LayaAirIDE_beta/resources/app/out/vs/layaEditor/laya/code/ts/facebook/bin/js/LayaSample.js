var LayaSample = /** @class */ (function () {
    ...
    LayaSample.prototype.initializeAsync = function () {
     ...
     *
     */
    LayaSample.prototype.onBtnChoose = function () {
     ...
     *
     */
    LayaSample.prototype.onBtnFriend = function () {
     ...
     *
     */
    LayaSample.prototype.onBtnLoading = function () {
     ...
     *
     */
    LayaSample.prototype.onBtnSave = function () {
     ...
     *
     */
    LayaSample.prototype.onBtnLogout = function () {
     ...
     *
     */
    LayaSample.prototype.onBtnShare = function () {
        alert("调用了'分享 '接口,此项目为模拟项目,具体效果请在facebook环境下调试");
        var payload = new laya.utils.Browser.window.SharePayload();
