...
(function(window,document,Laya){
	...
	var HttpRequest=laya.net.HttpRequest,IDEAPIS=laya.ide.managers.IDEAPIS,IDEEvent=laya.ide.event.IDEEvent,Image$1=laya.ui.Image;
	var Input=laya.display.Input,Loader$1=laya.net.Loader,MathUtil=laya.maths.MathUtil,MovieClip=laya.ani.swf.MovieClip;
	var Node=laya.display.Node,Notice=ide.managers.Notice,Particle2D=laya.particle.Particle2D,Point=laya.maths.Point;
	var Pool=laya.utils.Pool,Rectangle=laya.maths.Rectangle,ResFileManager=laya.ide.managers.ResFileManager,Skeleton=laya.ani.bone.Skeleton;
	var SoundNode=laya.media.SoundNode,Sprite=laya.display.Sprite,Text$1=laya.display.Text,Texture=laya.resource.Texture;
	var Tween=laya.utils.Tween,URL=laya.net.URL,Utils=laya.utils.Utils,View=laya.ui.View;
	...
	*多边形工具
	*/
	//class laya.editorUI.phisics.VerticleTool
	var VerticleTool=(function(){
		function VerticleTool(){}
		__class(VerticleTool,'laya.editorUI.phisics.VerticleTool');
		return VerticleTool;
	})()
	...
	*/
	...
	var Initiator=(function(){
		...
		Initiator.init=function(parms){
			...
			if (parms.createComp){
				View$1.createComp=parms.createComp;
			}
			return {}
		}
	...
	*/
	...
	var SpritePlayer=(function(_super){
		...
		__proto.__createIcon=function(){
			if (!this.pic){
				this.pic=new Image$1();
				this.pic.scaleX=this.pic.scaleY=0.5;
				this.pic.skin=ResFileManager.getIDECompIconPath(this.iconSign);
				if(!IDEAPIS.isPreview)
					this.addChild(this.pic);
				}else{
				this.pic.skin=ResFileManager.getIDECompIconPath(this.iconSign);
			}
			Laya.timer.callLater(this,this._updateIconSize);
		}

		__proto._updateIconSize=function(){
			if (this.pic&&this._width && this._height){
				this.pic.scale(1,1);
				this.pic.size(this._width,this._height);
			}
		}
		...
		__getset(0,__proto,'texture',function(){
			return _super.prototype._$get_texture.call(this);
			},function(value){
			if (!value){
				_super.prototype._$set_texture.call(this,null);
				return;
			}
			if ((typeof value=='string')){
				var textureRes=value;
				_super.prototype._$set_texture.call(this,Loader.getRes(textureRes));
				if(this.pic)this.pic.visible=false;
				}else{
				_super.prototype._$set_texture.call(this,value);
			}
		});

		__getset(0,__proto,'iconSign',function(){
			return this._iconSign;
			},function(value){
			this._iconSign=value;
			this.__createIcon();
		});
	...
	*/
	...
	var GraphicBase=(function(_super){
		...
		__proto.updateCompKeyValue=function(key,value){
			var data;
			data=this["comXml"];
			this[key]=value;
			if (data && data.props){
		...
		__proto.updateCompKeysValue=function(keys){
			var data;
			data=this["comXml"];
			var i=0,len=0;
			var key;
	...
	*@author ww
	*/
	//class laya.editorUI.codeflow.FunctionDefine extends laya.ui.Component
	var FunctionDefine=(function(_super){
		function FunctionDefine(){
			FunctionDefine.__super.call(this);
		}

		__class(FunctionDefine,'laya.editorUI.codeflow.FunctionDefine',_super);
	...
	*/
	...
	var DrawLines=(function(_super){
		...
		__proto.getPointsByStr=function(str){
			var pointArr;
			pointArr=str.split(this.SplitSign);
			var i=0,len=0;
			len=pointArr.length;
			for (i=0;i < len;i++){
				pointArr[i]=parseFloat(pointArr[i]);
		...
		__proto.updateTos=function(){
			this.points=this.getPointsArrBySpList(this.pointSpList).join(this.SplitSign);
			this.drawSelf();
		}
	...
	*/
	...
	var Script=(function(_super){
		...
		__proto.__createIcon=function(){
			this._iconSign="Script";
			_super.prototype.__createIcon.call(this);
		}
	...
	*/
	//class laya.editorUI.phisics.CircleCollider extends laya.editorUI.graphic.GraphicBase
	var CircleCollider=(function(_super){
		...
		__class(CircleCollider,'laya.editorUI.phisics.CircleCollider',_super);
		var __proto=CircleCollider.prototype;
		__proto.fitsize=function(){
			this.radius=this.parent.width *0.5;
			this.x=0;
			this.y=this.parent.height*0.5-this.radius;
			this.drawSelf();
			this.updateCompKeysValue(["x","y","radius"]);
		}

		__proto.drawSelf=function(){
			this.graphics.clear();
			if (this.isSelectState){
				this.graphics.drawCircle(this.radius,this.radius,this.radius,this.fillColor,this.lineColor,4);
				}else{
				this.graphics.drawCircle(this.radius,this.radius,this.radius,this.fillColor,this.lineColor,this.lineWidth);
			}
		}
	...
	*/
	//class laya.editorUI.phisics.TrapezoidCollider extends laya.editorUI.graphic.GraphicBase
	var TrapezoidCollider=(function(_super){
		function TrapezoidCollider(){
			this.slope=0.5;
			TrapezoidCollider.__super.call(this);
		}

		__class(TrapezoidCollider,'laya.editorUI.phisics.TrapezoidCollider',_super);
		var __proto=TrapezoidCollider.prototype;
		__proto.drawSelf=function(){
			this.graphics.clear();
			var tSlope=NaN;
			tSlope=this.slope *0.5;
			var roof=(1-(tSlope *2))*this.width;
			var x1=this.width *tSlope;
			var x2=x1+roof;
			var x3=x2+x1;
			var verticesPath;
			if (tSlope < 0.5){
				verticesPath=[0,0,x1,-this.height,x2,-this.height,x3,0];
			}
			else {
				verticesPath=[0,0,x2,-this.height,x3,0];
			}
			this.graphics.drawPoly(0,this.height,verticesPath,this.fillColor,this.lineColor,this.lineWidth);
		}
	...
	*/
	//class laya.editorUI.phisics.PolygonCollider extends laya.editorUI.graphic.DrawCircle
	var PolygonCollider=(function(_super){
		...
		__class(PolygonCollider,'laya.editorUI.phisics.PolygonCollider',_super);
		var __proto=PolygonCollider.prototype;
		//public var radius:Number=50;
		__proto.drawSelf=function(){
			this.graphics.clear();
			var theata=2 *Math.PI / this.sides;
			var offset=NaN;
			offset=0.5 *theata;
			var i=0,len=0;
			len=this.sides;
			...
			this.graphics.drawPoly(this.radius,-rec.y,points,this.fillColor,this.lineColor,this.lineWidth);
		}
	...
	*/
	//class laya.editorUI.phisics.BoxCollider extends laya.editorUI.graphic.DrawRect
	var BoxCollider=(function(_super){
		function BoxCollider(){
			this._ideBorderColor="#ffff00";
		...
		__class(BoxCollider,'laya.editorUI.phisics.BoxCollider',_super);
		...
		__proto.fitsize=function(){
			...
			this.drawSelf();
			this.updateCompKeysValue(["x","y","width","height"]);
		}
	...
	*@author ww
	*/
	//class laya.editorUI.NoIconItem extends laya.editorUI.Script
	var NoIconItem=(function(_super){
		function NoIconItem(){
			NoIconItem.__super.call(this);
			this.pic.visible=false;
		}

		__class(NoIconItem,'laya.editorUI.NoIconItem',_super);
		return NoIconItem;
	})(Script)
	...
	*约束
	*/
	//class laya.editorUI.phisics.Constraint extends laya.editorUI.Script
	var Constraint=(function(_super){
		function Constraint(){
			...
			Constraint.__super.call(this);
			this.pic.visible=false;
			this._myPoint=this.createPointSprite("#00ff00");
			this._otherPoint=this.createPointSprite("#ff0000");
			this.setIDESelectState(false);
		}

		__class(Constraint,'laya.editorUI.phisics.Constraint',_super);
		var __proto=Constraint.prototype;
		__proto.createPointSprite=function(color){
			var sp;
			sp=new Sprite();
			...
			this.addChild(sp);
			sp.visible=false;
			sp.on(/*laya.events.Event.MOUSE_DOWN*/"mousedown",this,this.onMouseDown,[sp]);
			sp.on(/*laya.events.Event.DRAG_END*/"dragend",this,this.onDragEnd,[sp]);
			return sp;
		}

		__proto.onMouseDown=function(sp,e){
			e.stopPropagation();
			this._isDraging=true;
			sp.startDrag();
		}

		__proto.onDragEnd=function(sp){
			this._isDraging=false;
			this.updatePoint(sp);
		}

		__proto.updatePoint=function(sp){
			if (sp==this._otherPoint){
				var tarDisplay;
				var point;
				tarDisplay=IDEAPIS.GetNodeByNodeRefer(this.other);
				Constraint._point.setTo(this._otherPoint.x,this._otherPoint.y);
				Constraint._point=this.localToGlobal(Constraint._point);
				if (tarDisplay){
					Constraint._point=tarDisplay.globalToLocal(Constraint._point);
				}
				else {
					Constraint._point=IDEAPIS.globalToDesignGlobal(Constraint._point);
				}
				this.updateKeyValue("otherPoint",[Math.round(Constraint._point.x),Math.round(Constraint._point.y)].join(","));
			}
			if (sp==this._myPoint){
				Constraint._point.setTo(this._myPoint.x,this._myPoint.y);
				Constraint._point=this.toParentPoint(Constraint._point);
				this.updateKeyValue("selfPoint",[Math.round(Constraint._point.x),Math.round(Constraint._point.y)].join(","));
			}
		}

		__proto.updateKeyValue=function(key,value){
			var data;
			data=this["comXml"];
			this[key]=value;
			if (data && data.props){
		...
		__proto.setIDESelectState=function(isSelect){
			...
			if (isSelect){
				this.pic.visible=false;
				this._myPoint.visible=true;
				this._otherPoint.visible=true;
			}
			else {
				this.graphics.clear();
				this.pic.visible=false;
				this._myPoint.visible=false;
				this._otherPoint.visible=false;
			}
			this.repaint();
		}

		__proto.getPointFromPointStr=function(point,tarPoint){
			if (!tarPoint)
				tarPoint=Constraint._point;
			if (!point)
		...
		__proto.drawPointAndLine=function(){
			this.graphics.clear();
			var tarDisplay;
			var point;
			if (!this._isDraging){
				tarDisplay=IDEAPIS.GetNodeByNodeRefer(this.other);
				point=this.getPointFromPointStr(this.otherPoint,Constraint._pointA);
				if (tarDisplay){
				...
				this._otherPoint.pos(point.x,point.y);
				point=this.getPointFromPointStr(this.selfPoint,Constraint._pointB);
				this.fromParentPoint(point);
				this._myPoint.pos(point.x,point.y);
			}
			this.graphics.drawLine(this._myPoint.x,this._myPoint.y,this._otherPoint.x,this._otherPoint.y,"#ffff00");
		}
		...
		__static(Constraint,
		['_point',function(){return this._point=new Point();},'_pointA',function(){return this._pointA=new Point();},'_pointB',function(){return this._pointB=new Point();}
		]);
		return Constraint;
	})(Script)
	...
	*刚体
	*/
	//class laya.editorUI.phisics.RigidBody extends laya.editorUI.Script
	var RigidBody=(function(_super){
		...
		__class(RigidBody,'laya.editorUI.phisics.RigidBody',_super);
	...
	*/
	...
	var View$1=(function(_super){
		...
		__class(View,'laya.editorUI.View',_super,'View$1');
	...
	*@author ww
	*/
	//class laya.editorUI.codeflow.CodeFlowItem extends laya.ui.View
	var CodeFlowItem=(function(_super){
		function CodeFlowItem(){
			CodeFlowItem.__super.call(this);
			this.drawSelf();
			this.on(/*laya.events.Event.MOUSE_DOWN*/"mousedown",this,this.onMouseDown);
			this.on(/*laya.events.Event.DRAG_END*/"dragend",this,this.onDragEnd);
		}

		__class(CodeFlowItem,'laya.editorUI.codeflow.CodeFlowItem',_super);
		var __proto=CodeFlowItem.prototype;
		...
		__proto.setDragPointEvent=function(dragPoint,params){
			dragPoint.on(/*laya.events.Event.MOUSE_DOWN*/"mousedown",this,this.onDragPointMouseDown,[dragPoint]);
			dragPoint.on(/*laya.events.Event.DRAG_END*/"dragend",this,this.onDragPointDragEnd,[dragPoint,params]);
		}

		__proto.onDragPointMouseDown=function(dragPoint){}
		__proto.onDragPointDragEnd=function(dragPoint,params){}
		__proto.addDragPoints=function(){}
		__proto.initByConfig=function(configO){}
		CodeFlowItem._dragPoint=null
		return CodeFlowItem;
	})(View)
	...
	var List=(function(_super){
		...
		*/
		...
		__proto.createItem=function(){
			var rst;
			rst=(typeof this._itemRender=='function')? new this._itemRender():View$1.createComp(this._itemRender);
			return rst;
		}
	...
	*/
	...
	var ViewStack=(function(_super){
		...
		*/
		__proto.initItems=function(){
			...
			for (var i=0;i < 10000;i++){
				...
				this._items.push(item);
				if (!ViewStack.disableSeleteIndex){
		...
		*/
		__proto.setSelect=function(index,selected){
			if (ViewStack.disableSeleteIndex)return;
		...
		*/
		...
		ViewStack.disableSeleteIndex=true;
		return ViewStack;
	})(Box)
	...
	*多边形
	*/
	//class laya.editorUI.phisics.VerticesCollider extends laya.editorUI.graphic.DrawPoly
	var VerticesCollider=(function(_super){
		//public var points:String;
		function VerticesCollider(){
			VerticesCollider.__super.call(this);
			this.SplitSign=" ";
		}

		__class(VerticesCollider,'laya.editorUI.phisics.VerticesCollider',_super);
		var __proto=VerticesCollider.prototype;
		__proto.drawWork=function(){
			_super.prototype.drawWork.call(this);
		}

		return VerticesCollider;
	})(DrawPoly)


	//class laya.editorUI.codeflow.ui.codeflow.IfItemUI extends laya.editorUI.codeflow.CodeFlowItem
	var IfItemUI=(function(_super){
		function IfItemUI(){
			this.elseDragPoint=null;
			this.thenDragPoint=null;
			IfItemUI.__super.call(this);
		}

		__class(IfItemUI,'laya.editorUI.codeflow.ui.codeflow.IfItemUI',_super);
		var __proto=IfItemUI.prototype;
		__proto.createChildren=function(){
			laya.ui.Component.prototype.createChildren.call(this);
			this.createView(IfItemUI.uiView);
		}

		IfItemUI.uiView={"type":"CodeFlowItem","props":{"width":91,"height":71},"child":[{"type":"Poly","props":{"y":32,"x":18,"points":"-12,6,27,-29,71,3,29,33","lineWidth":1,"lineColor":"#ff0000","fillColor":"#00ffff"}},{"type":"Sprite","props":{"y":60,"x":44,"var":"elseDragPoint","pivotY":4,"pivotX":4},"child":[{"type":"Circle","props":{"y":8,"x":8,"radius":8,"lineWidth":1,"lineColor":"#000000","fillColor":"#8eff00"}}]},{"type":"Sprite","props":{"y":30,"x":85,"var":"thenDragPoint","pivotY":4,"pivotX":4},"child":[{"type":"Circle","props":{"y":8,"x":8,"radius":8,"lineWidth":1,"lineColor":"#000000","fillColor":"#8eff00"}}]},{"type":"Label","props":{"y":28,"x":31,"width":36,"text":"label","height":16}}]};
		return IfItemUI;
	})(CodeFlowItem)
	...
	*@author ww
	*/
	//class laya.editorUI.codeflow.IFItem extends laya.editorUI.codeflow.ui.codeflow.IfItemUI
	var IFItem=(function(_super){
		function IFItem(){
			IFItem.__super.call(this);
		}

		__class(IFItem,'laya.editorUI.codeflow.IFItem',_super);
		var __proto=IFItem.prototype;
		__proto.drawSelf=function(){}
		//this.graphics.clear();
		__proto.addDragPoints=function(){}
		return IFItem;
